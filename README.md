...
- ✅ Realtek RTL8151 (automatically configured)
- ✅ Most standard USB-to-Ethernet adapters
- Note: Some Realtek adapters initially appear as CD-ROM devices - this is automatically fixed during installation
